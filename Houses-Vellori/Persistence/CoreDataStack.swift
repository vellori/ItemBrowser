...
class CoreData {
    ...
    static func newContext() -> NSManagedObjectContext {
        return CoreData.stack.persistentContainer.newBackgroundContext()
    }
    
    static var viewContext: NSManagedObjectContext {
        get {
            return CoreData.stack.persistentContainer.viewContext
        }
    }
}
...
private class CoreDataStack {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "Houses")
